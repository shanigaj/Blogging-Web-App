      ...
      >
        ...
        <div className="relative mb-5">
          <input
            ...
            className="border border-gray-300 rounded-lg py-2.5 px-4 pr-11 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
            required
            disabled={loading}
          />
          <button
